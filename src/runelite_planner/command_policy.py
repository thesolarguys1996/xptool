...
# Keep this aligned with plugin-side CommandSupportPolicy.
SUPPORTED_COMMAND_TYPES: Final[frozenset[str]] = frozenset(
    {
        "OPEN_BANK",
        "BANK_OPEN_SAFE",
        "ENTER_BANK_PIN",
...
def is_supported_command_type(command_type: str) -> bool:
