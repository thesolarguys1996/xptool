...
class InteractionSessionFactoryDefaultEntryRuntimeBundleFactoryInputsFactoryTest {
    ...
    @Test
    void exposesDefaultEntryRuntimeBundleFactoryInputsFactoryEntryPoints() throws NoSuchMethodException {
        assertNotNull(
            InteractionSessionFactoryDefaultEntryRuntimeBundleFactoryInputsFactory.class.getDeclaredMethod(
