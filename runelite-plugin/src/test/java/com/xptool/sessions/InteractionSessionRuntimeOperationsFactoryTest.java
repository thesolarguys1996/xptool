...
class InteractionSessionRuntimeOperationsFactoryTest {
    @Test
    void createFromRuntimeBundleBuildsOperationsThatDelegateToRuntimeServices() {
        int[] clickEvents = {0};
        ...
        InteractionSessionRuntimeOperations runtimeOperations =
            InteractionSessionRuntimeOperationsFactory.createFromRuntimeBundle(bundle);

        assertTrue(runtimeOperations.supports("WOODCUT_CHOP_NEAREST_TREE_SAFE"));
        CommandExecutor.CommandDecision decision = runtimeOperations.execute(
        ...
        runtimeOperations.onInteractionClickEvent(
